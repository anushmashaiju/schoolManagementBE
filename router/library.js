...
// Route to add a new library history record (protected)
...
// Route to get all library history (protected)
libraryRouter.get('/library/all', verifyToken, getAllLibraryHistory);

// Route to update a library history record (protected)
libraryRouter.put('/library/:id', verifyToken, updateLibraryHistory);

// Route to delete a library history record (protected)
